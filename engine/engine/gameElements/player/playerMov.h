...
namespace gameElements {
	...
	public:
		...
		enum nodeId_e {
			...
			CANNON_LAND = 0x1144 | COD_CAN_SHOOT | COD_ON_DASH_HOLD | COD_FLOWERPATH,
			TRAMPOLINE = 0x1200,
			...
			QUAKE_HITGROUND = 0x1315 | COD_ON_QUAKE | COD_DISABLE_LOOKAT | COD_DAMAGE_PROTECT | COD_FLOWERPATH,
			QUAKE_PUNCHGROUND = 0x1318 | COD_ON_QUAKE | COD_DISABLE_LOOKAT | COD_DAMAGE_PROTECT | COD_FLOWERPATH,
			...
			QUAKE_GETUP = 0x1330 | COD_CAN_QUAKE | COD_FLOWERPATH,
			LIANA = 0x1400 | COD_MANAGES_TILT | COD_DISABLE_LOOKAT,
			LIANA_GRAB = 0x1410 |  COD_MANAGES_TILT | COD_DISABLE_LOOKAT,
			LIANA_STAY = 0x14A0 |  COD_MANAGES_TILT | COD_DISABLE_LOOKAT,
			LIANA_INPUT = 0x14B0 | COD_MANAGES_TILT | COD_DISABLE_LOOKAT,
			LIANA_DROP = 0x14B2 |  COD_MANAGES_TILT | COD_DISABLE_LOOKAT,
			LIANA_JUMP = 0x14B3 |  COD_MANAGES_TILT | COD_DISABLE_LOOKAT,
			LIANA_GRASP = 0x14B4 | COD_MANAGES_TILT | COD_DISABLE_LOOKAT,
			LIANA_MOVE = 0x14B5 |  COD_MANAGES_TILT | COD_DISABLE_LOOKAT,
			LIANA_IDLE = 0x14B6 |  COD_MANAGES_TILT | COD_DISABLE_LOOKAT,
			LIANA_EXIT = 0x1420 |  COD_MANAGES_TILT | COD_DISABLE_LOOKAT,
			CREEP = 0x1500,
			CREEP_STAY = 0x1580,
			...
			IMPULSE_LAND = 0x1630 | COD_CAN_SHOOT | COD_ON_DASH_HOLD | COD_CAN_QUAKE | COD_FLOWERPATH,
			...
			AIR_LAND = 0x1730 | COD_CAN_SHOOT | COD_ON_DASH_HOLD | COD_CAN_QUAKE | COD_FLOWERPATH,
			GROUND = 0x2000 | COD_CAN_SHOOT | COD_CAN_QUAKE,
			RUN = 0x2100 | COD_CAN_SHOOT | COD_ON_DASH_HOLD | COD_CAN_QUAKE | COD_FLOWERPATH,
			DASH = 0x2200 | COD_FLOWERPATH,
			DASH_HOLD = 0x2210 | COD_FLOWERPATH,
			DASH_SETUP = 0x2220 | COD_DISABLE_LOOKAT | COD_DASHING | COD_FLOWERPATH,
			DASH_DURING = 0x2221 | COD_DISABLE_LOOKAT | COD_DASHING | COD_FLOWERPATH,
			DASH_TACKLED = 0x2230 | COD_DISABLE_LOOKAT | COD_DASHING,
			DASH_BOUNCE = 0x2231 | COD_DISABLE_LOOKAT | COD_CAN_QUAKE | COD_FLOWERPATH,
			DASH_STOP = 0x2232 | COD_CAN_SHOOT | COD_CAN_QUAKE | COD_FLOWERPATH,
			JUMP = 0x2300 | COD_CAN_SHOOT | COD_CAN_QUAKE,
			JUMP_IMPULSE = 0x2310 | COD_TILT_ON_VELOCITY | COD_CAN_SHOOT | COD_ON_DASH_HOLD,
			JUMP_SET_JUMPED = 0x2320 | COD_TILT_ON_VELOCITY | COD_CAN_SHOOT,
			IDLE = 0x2400 | COD_CAN_SHOOT | COD_ON_DASH_HOLD | COD_CAN_QUAKE | COD_HIGHLIGHT_TRANSFORMABLES | COD_FLOWERPATH,
			SPAWN = 0x2500 | COD_FLOWERPATH,
			SPAWN_GROUND = 0x2501 | COD_FLOWERPATH,
			SPAWN_FALL = 0x2502 | COD_DISABLE_LOOKAT | COD_DAMAGE_PROTECT | COD_FLOWERPATH,
			SPAWN_ANIM = 0x2504 | COD_DISABLE_LOOKAT | COD_DAMAGE_PROTECT | COD_FLOWERPATH,
			CREEP_MOVE_UP = 0xC001 | COD_DISABLE_LOOKAT,
			CREEP_MOVE_RIGHT = 0xC004 | COD_DISABLE_LOOKAT,
			IDLE_LONG = 0x24c1 | COD_DISABLE_LOOKAT_HEADONLY | COD_CAN_SHOOT | COD_ON_DASH_HOLD | COD_CAN_QUAKE | COD_HIGHLIGHT_TRANSFORMABLES,
		};
