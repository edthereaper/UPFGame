...
MIDL_INTERFACE("A1EB4141-9A66-4097-A5B0-6FC84F8B162C") IFW1DWriteRenderTarget : public IFW1Object {
	...
	/// <param name="FontSize">The size of the font.</param>
	/// <param name="RenderingMode">The DirectWrite render mode. See DirectWrite documentation.</param>
...
/// <remarks>When render a string, a vertex is inserted into an IFW1TextGeometry object for each glyph.
